...
<head>
    ...
    <style>
        body { background: linear-gradient(135deg, #eef2f3, #8e9eab); min-height: 100vh; font-family: Arial, sans-serif; }
        .container { margin-top: 40px; }
        .header-box { background: white; padding: 15px 20px; border-radius: 15px; box-shadow: 0 5px 20px rgba(0, 0, 0, 0.1); }
        .search-box { border-radius: 12px; padding-left: 40px; }
        .search-icon { position: absolute; margin-left: 12px; margin-top: 10px; color: gray; }
...
<body>
    <div class="container">
        ...
        <div class="position-relative mb-3">
            ...
            <input type="text" id="search" class="form-control search-box shadow-sm" placeholder="Search by name or email...">
        </div>
                    ...
                    <tbody id="table-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/profiles/delete/{{ $profile->id }}" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-sm">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
